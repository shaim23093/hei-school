...
import static school.hei.admin.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.admin.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.hei.admin.event1";
    return "school.hei.admin.event2";
  }
}
